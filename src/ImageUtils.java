...
public class ImageUtils {
  ...
  private static String fileURIFromBufferedImage( BufferedImage img, String name ){
    ...
    try {
      ImageIO.write( img, "png", new File("./output/" + name + ".png" ).getCanonicalFile());
      byte[] imageBytes = Files.readAllBytes( Paths.get(new File("./output/" + name + ".png").getCanonicalPath()) );
      img.flush();
      uri =  new File("./output/" + name + ".png" ).getAbsolutePath();
